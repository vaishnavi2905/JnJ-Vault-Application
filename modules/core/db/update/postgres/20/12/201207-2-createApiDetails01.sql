...
alter table VAULT_API_DETAILS add constraint FK_VAULT_API_DETAILS_ON_INT_ASSET foreign key (INT_ASSET_ID) references VAULT_INT_DETAILS(ID);
...
alter table VAULT_API_DETAILS add constraint FK_VAULT_API_DETAILS_ON_API_DEST_PROTOCOL foreign key (API_DEST_PROTOCOL_ID) references VAULT_MASTER_DATA(ID);
...
create index IDX_VAULT_API_DETAILS_ON_INT_ASSET on VAULT_API_DETAILS (INT_ASSET_ID);
